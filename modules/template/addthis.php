...
<style type="text/css">
    .btn.button_facebook{background-color:rgb(59, 89, 152);}
    .btn.button_twitter{background-color:rgb(29, 161, 242);}
    .btn.button_google_plusone_share{background-color:rgb(220, 78, 65);}
    .btn.button_youtube{background-color:rgb(205, 32, 31);}
    .btn.button_linkedin{background-color:rgb(0, 119, 181);}
    .btn.button_print{background-color:rgb(115, 138, 141);}
    .btn.button_email{background-color:rgb(132, 132, 132);}
</style>